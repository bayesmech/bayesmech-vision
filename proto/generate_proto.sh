...
if python -c "import grpc_tools" 2>/dev/null; then
    python -m grpc_tools.protoc \
        -I. \
        --python_out=. \
        primitives.proto perceiver.proto control.proto spatial.proto segmentation.proto motioncap.proto insightgen.proto reconstruction.proto idoslam.proto snookestown.proto pongtown.proto vggt.proto
else
    protoc \
        -I. \
        --python_out=. \
...
from . import insightgen_pb2
from . import reconstruction_pb2
from . import idoslam_pb2
from . import snookestown_pb2
from . import pongtown_pb2
EOF
